      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="flex items-center mb-8">
            ...
            <span className="text-2xl font-bold">Dutch CRM</span>
          </div>

          {/* Main Content */}
          <h1 className="text-4xl font-bold mb-6">Krachtige Customer Relationship Management</h1>

          <p className="text-xl text-slate-300 mb-12 leading-relaxed">
            Beheer uw klanten, leads en verkoop effectief. Versterk klantrelaties en verhoog uw omzet met ons
            uitgebreide CRM-platform.
          </p>
          ...
          <div className="space-y-6 mb-12">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">Centraliseer klantgegevens en beheer relaties effectief.</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Volg prestaties met gedetailleerde verkoop analytics en inzichten.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Converteer prospects naar klanten met gestructureerde lead tracking.
                </p>
              </div>
            </div>
          </div>
          ...
          <blockquote className="border-l-4 border-orange-500 pl-6">
            <p className="text-slate-300 italic mb-2">
              "Deze CRM heeft onze klantrelaties getransformeerd. De interface is intuïtief en de functies zijn precies
              wat we nodig hadden."
            </p>
            <cite className="text-sm text-slate-400">— Pieter Janssen, Sales Manager</cite>
          </blockquote>
        </div>
      </div>
